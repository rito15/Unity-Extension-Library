...
namespace Rito.Extensions
{
    public static class TypeExtension
    {
        ...
        /// </summary>
        public static string ToStringSimple(this Type @this)
        {
        ...
        /// </summary>
        public static bool IsChildOrEqualsTo(this Type @this, in Type target)
        {
            return @this.IsSubclassOf(target) || @this.IsEquivalentTo(target);
        }

        /// <summary> 배열 타입인지 검사 </summary>
        public static bool IsArrayType(this Type @this)
        {
            return @this.IsArray;
        }
        ...
        public static bool IsArrayOrListType(this Type @this)
        {
            return @this.IsArray ||
        ...
        /// </summary>
        public static bool IsArrayAndChildOf(this Type @this, in Type target)
        {
        ...
        /// </summary>
        public static bool IsListAndChildOf(this Type @this, in Type target)
        {
